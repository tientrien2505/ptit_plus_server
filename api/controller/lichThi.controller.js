        ...
        if (capcha != null){
            request.post({
                ...
                request.post({
                    ...
                    let url = 'http://qldt.ptit.edu.vn/default.aspx';
                    request.get({
                        url : url,
                        qs : {
                            page : 'xemlichthi',
                        ...
                        for(var i = 0; i< temp.length;i = i+11){
                            let jsonObject = {}
                            jsonObject.stt = temp[i + 0]
                            jsonObject.MaMH = temp[i + 1]
                            jsonObject.TenMH = temp[i + 2]
                            jsonObject.NgayThi = temp[i + 6]
                            jsonObject.GioBD = temp[i + 7]
                            jsonObject.SoPhut = temp[i + 8]
                            jsonObject.Phong = temp[i + 9]
                            jsonObject.GhiChu = temp[i + 10]
